...
type User struct {
	...
	SpeedLimitUpMbps   uint64 `protobuf:"varint,4,opt,name=speed_limit_up_mbps,json=speedLimitUpMbps,proto3" json:"speedLimitUpMbps,omitempty"`
	SpeedLimitDownMbps uint64 `protobuf:"varint,5,opt,name=speed_limit_down_mbps,json=speedLimitDownMbps,proto3" json:"speedLimitDownMbps,omitempty"`
